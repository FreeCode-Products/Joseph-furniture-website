...
import { generateFAQSchema, COMMON_FAQS } from "@/lib/seo-schemas";
...
export default function FAQSection({
  ...
  description = "Find answers to common questions about our furniture and services.",
}: FAQSectionProps) {
    ...
    <section className="py-20 bg-cream">
      ...
      <div className="max-w-3xl mx-auto px-4 sm:px-6">
        ...
        >
          ...
          <p className="text-lg text-charcoal/60">{description}</p>
        </motion.div>
        ...
        <div className="space-y-4">
          {items.map((faq, index) => (
            <motion.div
              ...
              className="border border-charcoal/10 rounded-lg overflow-hidden bg-white hover:shadow-md transition-shadow"
            >
              <button
                onClick={() =>
              ...
              >
                <h3 className="text-left font-semibold text-charcoal text-lg">
                  {faq.question}
                </h3>
                <motion.div
              ...
              <AnimatePresence>
                {expandedIndex === index && (
                  ...
                  >
                    <p className="px-6 py-4 text-charcoal/70 leading-relaxed">
                      {faq.answer}
                    </p>
                  </motion.div>
                )}
